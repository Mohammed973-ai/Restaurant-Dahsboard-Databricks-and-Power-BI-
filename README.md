# Restaurant-Dahsboard-Databricks-and-Power-BI

## Handling Big Data with Databricks and Power BI

## video here on how fast this huge data is processed in Power BI : https://youtu.be/MUkJQON3qRw?si=73FVMQw_hM9vv2yo

Despite working with datasets exceeding **11 million rows**, I am able to analyze and visualize them seamlessly using **Power BI**. You might wonder, how is that possible? 

The answer lies in using the **Databricks platform**—a comprehensive, "all-in-one" solution designed for Data Engineers, Data Analysts, and Data Scientists.
...
<img width="1433" height="819" alt="Menu_and_category" src="https://github.com/user-attachments/assets/a6777ed1-213d-414b-978d-1eabf52afa7f" />
